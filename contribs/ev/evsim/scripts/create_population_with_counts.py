...
def create_population_and_plans_xml(alpha, node_coords, counts_path, output_file_path):
...
def main(input_file, countsinput, output_file, alpha):
    node_coords = get_node_coords(os.path.abspath(input_file))
    create_population_and_plans_xml(alpha, node_coords, os.path.abspath(countsinput), os.path.abspath(output_file))
